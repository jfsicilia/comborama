...
{ ; Class that handles writing to a log file
  ...
  log(entryString="", addNewLine=true, usePreEntryString=true, usePostEntryString=true) {
    return this.addLogEntry(entryString, addNewLine, usePreEntryString, usePostEntryString) 
  }
	...
	; 	plaintextString -> A string with any %var%/$var replaced by those variables values.
		...
		if(encodedString != "")
		{
			...
			{ 
				...
				Try { 
          Transform, encodedString, DeRef, %encodedString% 
